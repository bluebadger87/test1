...
namespace _26_Thread
{
    public partial class Play : Form
    {
        ...
        public void fThreadStart()
        {
            ...
            _thread = new Thread(Run);   // 컴파일러에서 델리게이트 객체를 추론해서 생성 후 생성 후 함수를 넘김
            _thread.Start();
        }
        ...
        private void Run()
        {
            ...
            //CheckForIllegalCrossThreadCalls = false;   // Thread 충돌에 대한 Cross Thread 무시 
            int ivar = 0;
            ...
            {
                if (this.InvokeRequired) //요청한 Thread가 현재 Main Thread 있는 Contorl을 엑세스 할 수 있는지 확인
                {
